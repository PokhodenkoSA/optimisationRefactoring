...
public:
  ...
  Standard_EXPORT static double Confusion();
  

  //! Returns square of Confusion.
  //! Created for speed and convenience.
  Standard_EXPORT static double SquareConfusion();
  ...
  //! (that is, 1.e-9).
  Standard_EXPORT static double Intersection();
  ...
  Standard_EXPORT static double Approximation();
  ...
  Standard_EXPORT static double Infinite();
