...
public:
  ...
  Standard_EXPORT Message_ProgressSentry(const Handle(Message_ProgressIndicator)& PI, const Standard_CString name, const double min, const double max, const double step, const Standard_Boolean isInf = Standard_False, const double newScopeSpan = 0.0);
  ...
  Standard_EXPORT Message_ProgressSentry(const Handle(Message_ProgressIndicator)& PI, const Handle(TCollection_HAsciiString)& name, const double min, const double max, const double step, const Standard_Boolean isInf = Standard_False, const double newScopeSpan = 0.0);
...
~Message_ProgressSentry()
{
  Relieve();
    ...
    void Next (const double span, const Standard_CString name = 0) const;
  
  //! Closes current scope and opens next one
  //! with either specified or default span
    void Next (const double span, const Handle(TCollection_HAsciiString)& name) const;
