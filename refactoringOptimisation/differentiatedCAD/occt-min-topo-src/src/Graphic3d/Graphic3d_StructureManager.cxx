...
Standard_Integer Limit  = Graphic3d_StructureManager::Limit ();
        ...
        Aspect_GenId theGenId(
          Standard_Integer (Structure_IDMIN+Coef.getValue()*(StructureManager_CurrentId)),
          Standard_Integer (Structure_IDMIN+Coef.getValue()*(StructureManager_CurrentId+1)-1));
