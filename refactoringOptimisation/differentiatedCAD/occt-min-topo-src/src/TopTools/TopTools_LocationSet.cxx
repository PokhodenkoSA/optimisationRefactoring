		      ...
		      const Standard_Boolean compact)
{
  ...
  if (!compact) OS << "( ";
  OS << setw(15) << M(1,1).getValue() << " ";
  OS << setw(15) << M(1,2).getValue() << " ";
  OS << setw(15) << M(1,3).getValue() << " ";
  OS << setw(15) << V.Coord(1).getValue() << " ";
  if (!compact) OS << " )";
  OS << "\n";
  if (!compact) OS << "( ";
  OS << setw(15) << M(2,1).getValue() << " ";
  OS << setw(15) << M(2,2).getValue() << " ";
  OS << setw(15) << M(2,3).getValue() << " ";
  OS << setw(15) << V.Coord(2).getValue() << " ";
  if (!compact) OS << " )";
  OS << "\n";
  if (!compact) OS << "( ";
  OS << setw(15) << M(3,1).getValue() << " ";
  OS << setw(15) << M(3,2).getValue() << " ";
  OS << setw(15) << M(3,3).getValue() << " ";
  OS << setw(15) << V.Coord(3).getValue() << " ";
  if (!compact) OS << " )";
  OS << "\n";
}
