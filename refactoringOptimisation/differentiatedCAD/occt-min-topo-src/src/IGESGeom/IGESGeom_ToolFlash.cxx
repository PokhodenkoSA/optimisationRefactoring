   ...
   const Handle(Message_Messenger)& S, const Standard_Integer level)  const
{
  ...
  S << " First sizing parameter  : " << ent->Dimension1().getValue() << "  ";
  S << " Second sizing parameter : " << ent->Dimension2().getValue() << endl;
  S << " Rotation about reference entity : " << ent->Rotation().getValue() << endl;
  S << "Reference Entity         : ";
