                                       ...
                                       const Standard_Integer level)  const
{
  ...
  S << "First Offset Distance      : " << ent->FirstOffsetDistance().getValue()  << "  ";
  S << "Arc Length : " << ent->ArcLength1().getValue() << endl;
  S << "Second Offset Distance     : " << ent->SecondOffsetDistance().getValue() << "  ";
  S << "Arc Length : " << ent->ArcLength2().getValue() << endl;
  S << "Normal Vector : ";
  IGESData_DumpXYZL(S,level, ent->NormalVector(), ent->VectorLocation());  S<<endl;
  S << "Offset curve Parameters. Starting : " << ent->StartParameter().getValue() << "  ";
  S << "Ending : " << ent->EndParameter().getValue()   << endl;
}
