  ...
  const Handle(Message_Messenger)& S, const Standard_Integer /*level*/)  const
{
  ...
  S << "| R11, R12, R13, T1 |       "
    << ent->Data(1, 1).getValue() << ", " << ent->Data(1, 2).getValue() << ", "
    << ent->Data(1, 3).getValue() << ", " << ent->Data(1, 4).getValue() << endl;

  S << "| R21, R22, R23, T2 |       "
    << ent->Data(2, 1).getValue() << ", " << ent->Data(2, 2).getValue() << ", "
    << ent->Data(2, 3).getValue() << ", " << ent->Data(2, 4).getValue() << endl;

  S << "| R31, R32, R33, T3 |       "
    << ent->Data(3, 1).getValue() << ", " << ent->Data(3, 2).getValue() << ", "
    << ent->Data(3, 3).getValue() << ", " << ent->Data(3, 4).getValue() << endl;
