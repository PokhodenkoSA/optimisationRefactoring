                                    ...
                                    const Standard_Integer level)  const
{
  ...
  S << "Conic Coefficient A : " << A.getValue() << endl;
  S << "Conic Coefficient B : " << B.getValue() << endl;
  S << "Conic Coefficient C : " << C.getValue() << endl;
  S << "Conic Coefficient D : " << D.getValue() << endl;
  S << "Conic Coefficient E : " << E.getValue() << endl;
  S << "Conic Coefficient F : " << F.getValue() << endl;
  S << "Z-Plane shift : " << ent->ZPlane().getValue() << endl;
  S << "Start Point : ";
  ...
  if (level <= 4) S<<" -- Computed Definition : ask level > 4" << endl;
    ...
    S<<endl;
    if (cf == 3) S << " Focal : " << Rmin.getValue() << endl;
    else if (Rmin == Rmax) S << " Radius (Major = Minor) : " << Rmin.getValue() << endl;
    else S << " Major Radius : " << Rmax.getValue() << "  Minor Radius : " << Rmin.getValue() <<endl;
