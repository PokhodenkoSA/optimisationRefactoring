...
TCollection_ExtendedString AIS_Dimension::GetValueString (Standard_Real& theWidth) const
{
  ...
  char aFmtBuffer[256];
  sprintf (aFmtBuffer, aFormatStr.ToCString(), ValueToDisplayUnits().getValue());
  ...
  if (myDrawer->DimensionAspect()->IsText3d())
  {
    ...
    Font_BRepFont aFont (aFontName, aFontAspect, aFontHeight.getValue());
  ...
  else
  {
    ...
    aFont->Init (aFontName, aFontAspect, (const unsigned int)aFontHeight.getValue(), THE_2D_TEXT_RESOLUTION);
