...
public:
  ...
  Standard_EXPORT void SetAxis (const Standard_Real X, const Standard_Real Y, const Standard_Real Z, const Standard_Real Vx, const Standard_Real Vy, const Standard_Real Vz);
  ...
  Standard_EXPORT void SetZClippingDepth (const Standard_Real theDepth);

  //! Defines the thickness around the medium clipping plane.
  Standard_EXPORT void SetZClippingWidth (const Standard_Real theWidth);
  ...
  Standard_EXPORT void SetZCueingDepth (const Standard_Real theDepth);

  //! Defines the thickness around the medium plane.
  Standard_EXPORT void SetZCueingWidth (const Standard_Real theWidth);
  ...
  //! If the eye, the view point, or the high point are
  //! aligned or confused.
  Standard_EXPORT void Rotate (const Standard_Real Ax, const Standard_Real Ay, const Standard_Real Az, const Standard_Real X, const Standard_Real Y, const Standard_Real Z, const Standard_Boolean Start = Standard_True);
  ...
  //! Start = Standard_True
  Standard_EXPORT void Rotate (const V3d_TypeOfAxe Axe, const Standard_Real Angle, const Standard_Real X, const Standard_Real Y, const Standard_Real Z, const Standard_Boolean Start = Standard_True);
  ...
  Standard_EXPORT void Convert (const Standard_Integer Xp, const Standard_Integer Yp, Standard_Real& Xv, Standard_Real& Yv) const;
  ...
  Standard_EXPORT void Convert (const Standard_Real Xv, const Standard_Real Yv, Standard_Integer& Xp, Standard_Integer& Yp) const;

  //! Converts the projected point into a point
  //! in the reference frame of the view corresponding
  //! to the intersection with the projection plane
  //! of the eye/view point vector.
  Standard_EXPORT void Convert (const Standard_Integer Xp, const Standard_Integer Yp, Standard_Real& X, Standard_Real& Y, Standard_Real& Z) const;
  ...
  Standard_EXPORT void ConvertWithProj (const Standard_Integer Xp, const Standard_Integer Yp, Standard_Real& X, Standard_Real& Y, Standard_Real& Z, Standard_Real& Vx, Standard_Real& Vy, Standard_Real& Vz) const;
  ...
  Standard_EXPORT void ConvertToGrid (const Standard_Integer Xp, const Standard_Integer Yp, Standard_Real& Xg, Standard_Real& Yg, Standard_Real& Zg) const;

  //! Converts the point into the nearest grid point
  //! and display the grid marker.
  Standard_EXPORT void ConvertToGrid (const Standard_Real X, const Standard_Real Y, const Standard_Real Z, Standard_Real& Xg, Standard_Real& Yg, Standard_Real& Zg) const;

  //! Projects the point defined in the reference frame of
  //! the view into the projected point in the associated window.
  Standard_EXPORT void Convert (const Standard_Real X, const Standard_Real Y, const Standard_Real Z, Standard_Integer& Xp, Standard_Integer& Yp) const;
  ...
  Standard_EXPORT void ProjReferenceAxe (const Standard_Integer Xpix, const Standard_Integer Ypix, Standard_Real& XP, Standard_Real& YP, Standard_Real& ZP, Standard_Real& VX, Standard_Real& VY, Standard_Real& VZ) const;
  ...
  Standard_EXPORT Standard_Boolean ZCueing (Standard_Real& theDepth, Standard_Real& theWidth) const;
  ...
  //! "SLICE"
  //! "OFF"
  Standard_EXPORT V3d_TypeOfZclipping ZClipping (Standard_Real& theDepth, Standard_Real& theWidth) const;
...
private:
  ...
  //! in the view.
  Standard_EXPORT void FitAll (const Handle(Aspect_Window)& aWindow, const Standard_Real Umin, const Standard_Real Vmin, const Standard_Real Umax, const Standard_Real Vmax);
