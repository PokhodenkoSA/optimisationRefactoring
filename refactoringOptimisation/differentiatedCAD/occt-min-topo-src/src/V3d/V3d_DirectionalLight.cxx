                                         ...
                                         const Standard_Real theVz)
{
  ...
  myLight.Direction.x() = static_cast<Standard_ShortReal> (aV.X().getValue());
  myLight.Direction.y() = static_cast<Standard_ShortReal> (aV.Y().getValue());
  myLight.Direction.z() = static_cast<Standard_ShortReal> (aV.Z().getValue());
}
...
//  The arrow is drawn
  ...
  aPrims->AddVertex(Standard_ShortReal(Xi.getValue()),Standard_ShortReal(Yi.getValue()),Standard_ShortReal(Zi.getValue()));
  aPrims->AddVertex(Standard_ShortReal(X.getValue()),Standard_ShortReal(Y.getValue()),Standard_ShortReal(Z.getValue()));
