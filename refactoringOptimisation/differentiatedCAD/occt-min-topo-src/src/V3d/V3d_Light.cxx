                          ...
                          const Standard_Real theValue3)
{
  ...
  Quantity_Color aColor (aValue1.getValue(), aValue2.getValue(), aValue3.getValue(), theType);
  SetColor (aColor);
}
...
{
  double theValue1Helper, theValue2Helper, theValue3Helper;
  Color().Values (theValue1Helper, theValue2Helper, theValue3Helper, theType);
  theValue1 = theValue1Helper;
  theValue2 = theValue2Helper;
  theValue3 = theValue3Helper;
}
...
{
  return Quantity_Color (double (myLight.Color.r()),
                         double (myLight.Color.g()),
                         double (myLight.Color.b()),
                         Quantity_TOC_RGB);
}
...
void V3d_Light::SetIntensity (const Standard_Real theValue)
{
  ...
  myLight.Intensity = static_cast<Standard_ShortReal> (theValue.getValue());
}
