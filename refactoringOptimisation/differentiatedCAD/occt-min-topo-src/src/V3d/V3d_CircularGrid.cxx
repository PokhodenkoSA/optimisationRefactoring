...
void V3d_CircularGrid::DefineLines ()
{
  ...
  const Standard_Integer Division = (Standard_Integer )( (aDivision >= DIVISION ? aDivision : DIVISION)).getValue();
  ...
  myCurStep = aStep, myCurDivi = (Standard_Integer ) aDivision.getValue();
}
