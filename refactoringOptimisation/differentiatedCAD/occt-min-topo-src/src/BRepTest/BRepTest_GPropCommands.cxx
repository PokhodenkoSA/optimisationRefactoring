...
Standard_Integer props(Draw_Interpretor& di, Standard_Integer n, const char** a)
{
  ...
  if (!isFullMode)
  {
    ...
    aSStream1 << "\n\n";
    aSStream1 << "Mass : " << setw(15) << G.Mass().getValue() << "\n" << "\n";
    if(witheps && *a[0] != 'l') aSStream1 << "Relative error of mass computation : " <<  setw(15) << eps.getValue() <<  "\n" << "\n";
  
    aSStream1 << "Center of gravity : \n";
    aSStream1 << "X = " << setw(15) << P.X().getValue() << "\n";
    aSStream1 << "Y = " << setw(15) << P.Y().getValue() << "\n";
    aSStream1 << "Z = " << setw(15) << P.Z().getValue() << "\n";
    aSStream1 << "\n";
  
    aSStream1 << "Matrix of Inertia : \n";
    aSStream1 << setw(15) << I(1,1).getValue();
    aSStream1 << " " << setw(15) << I(1,2).getValue();
    aSStream1 << " " << setw(15) << I(1,3).getValue() << "\n";
    aSStream1 << setw(15) << I(2,1).getValue();
    aSStream1 << " " << setw(15) << I(2,2).getValue();
    aSStream1 << " " << setw(15) << I(2,3).getValue() << "\n";
    aSStream1 << setw(15) << I(3,1).getValue();
    aSStream1 << " " << setw(15) << I(3,2).getValue();
    aSStream1 << " " << setw(15) << I(3,3).getValue() << "\n";
    aSStream1 << "\n";
    aSStream1 << ends;
    di << aSStream1;
    ...
    aSStream2 << "Moments : \n";
    aSStream2 << "IX = " << setw(15) << Ix.getValue() << "\n";
    aSStream2 << "IY = " << setw(15) << Iy.getValue() << "\n";
    aSStream2 << "IZ = " << setw(15) << Iz.getValue() << "\n";
    aSStream2 << "\n";
    aSStream2 << ends;
    di << aSStream2;
  }
...
//Standard_Real    aDefaultTol = 1.e-3;
  ...
  if(CGFlag || IFlag) {
    ...
    aSStream1 << "Center of gravity : \n";
    aSStream1 << "X = " << setw(anOutWidth) << P.X().getValue() << "\n";
    aSStream1 << "Y = " << setw(anOutWidth) << P.Y().getValue() << "\n";
    aSStream1 << "Z = " << setw(anOutWidth) << P.Z().getValue() << "\n";
    aSStream1 << "\n";
