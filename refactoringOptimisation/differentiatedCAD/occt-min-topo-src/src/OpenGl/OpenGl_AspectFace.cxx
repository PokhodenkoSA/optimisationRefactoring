...
void OpenGl_AspectFace::SetAspect (const Handle(Graphic3d_AspectFillArea3d)& theAspect)
{
  ...
  NCollection_Vec3<double> aColor;
  ...
  aFaceContext.Back.Shininess = float ((theAspect->BackMaterial ()).Shininess ().getValue());
  aFaceContext.Back.Ambient   = float ((theAspect->BackMaterial ()).Ambient ().getValue());
  aFaceContext.Back.Diffuse   = float ((theAspect->BackMaterial ()).Diffuse ().getValue());
  aFaceContext.Back.Specular  = float ((theAspect->BackMaterial ()).Specular ().getValue());
  aFaceContext.Back.Transparency  = float ((theAspect->BackMaterial ()).Transparency ().getValue());
  aFaceContext.Back.Emission      = float ((theAspect->BackMaterial ()).Emissive ().getValue());
  ...
  aFaceContext.Front.Shininess    = float ((theAspect->FrontMaterial ()).Shininess ().getValue());
  aFaceContext.Front.Ambient      = float ((theAspect->FrontMaterial ()).Ambient ().getValue());
  aFaceContext.Front.Diffuse      = float ((theAspect->FrontMaterial ()).Diffuse ().getValue());
  aFaceContext.Front.Specular     = float ((theAspect->FrontMaterial ()).Specular ().getValue());
  aFaceContext.Front.Transparency = float ((theAspect->FrontMaterial ()).Transparency ().getValue());
  aFaceContext.Front.Emission     = float ((theAspect->FrontMaterial ()).Emissive ().getValue());
