                          ...
                          const Standard_Boolean       theToDrawImmediate)
{
   ...
   && aContext->core11 != NULL)
  {
    ...
    if (myCamera->ZFar() < aFogFrontConverted)
    {
      ...
      myFog.Front = (Standard_ShortReal )(( tmp = aFogFrontConverted - myCamera->Distance()));
    }
    ...
    if (myCamera->ZFar() < aFogFrontConverted)
    {
      ...
      myFog.Back = (Standard_ShortReal )((tmp = aFogBackConverted - myCamera->Distance()));
    }
  ...
  if (myZClip.Back.IsOn || myZClip.Front.IsOn)
  {
    ...
    if (myZClip.Back.IsOn)
    {
      ...
      if (myCamera->ZFar() < aClipBackConverted)
      {
        ...
        myZClip.Back.Limit = (Standard_ShortReal )(tmp = (aClipBackConverted - myCamera->Distance()));
      }
    ...
    if (myZClip.Front.IsOn)
    {
      ...
      if (myCamera->ZNear() > aClipFrontConverted)
      {
        ...
        myZClip.Front.Limit = (Standard_ShortReal )(tmp = (aClipFrontConverted - myCamera->Distance()));
      }
      const Graphic3d_ClipPlane::Equation aFrontEquation (0.0, 0.0, -1.0, (Standard_ShortReal )(tmp = -aClipFrontConverted));
