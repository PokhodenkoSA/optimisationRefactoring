...
{ if (!surfconti.IsDone()) 
  ...
  switch(surfconti.ContinuityStatus())
    { case GeomAbs_C0 :{  if (surfconti.IsC0() )
                          ...
                          o<<" C0Value = "<<surfconti.C0Value().getValue() <<endl;
		       } break; 
      case GeomAbs_C1 :{ if (surfconti.IsC1()) 
			 ...
			 o<<" C0Value = "<<surfconti.C0Value().getValue()<<endl;
			 o<<" C1UAngle = "<<surfconti.C1UAngle().getValue()<<endl;
                         o<<" C1URatio = "<<surfconti.C1URatio().getValue()<<endl;
			 o<<" C1VAngle = "<<surfconti.C1VAngle().getValue()<<endl;
                         o<<" C1VRatio = "<<surfconti.C1VRatio().getValue()<<endl;
      ...
      case GeomAbs_C2 :{  if (surfconti.IsC2()) 
			 ...
			 o<<" C1UAngle = "<<surfconti.C1UAngle().getValue()<<endl;
			 o<<" C1VAngle = "<<surfconti.C1VAngle().getValue()<<endl;
			 o<<" C2UAngle = "<<surfconti.C2UAngle().getValue()<<endl;
			 o<<" C2VAngle = "<<surfconti.C2VAngle().getValue()<<endl;
			 o<<" C1URatio = "<<surfconti.C1URatio().getValue()<<endl;
			 o<<" C1VRatio = "<<surfconti.C1VRatio().getValue()<<endl;
			 o<<" C2URatio = "<<surfconti.C2URatio().getValue()<<endl;
			 o<<" C2VRatio = "<<surfconti.C2VRatio().getValue()<<endl;
		       } break; 
      case GeomAbs_G1 :{ if (surfconti.IsG1()) 
			 ...
			 o<<" G0Value = "<<surfconti.C0Value().getValue()<<endl;
			 o<<" G1Angle = "<<surfconti.G1Angle().getValue()<<endl<<endl;
		       } break;
      case GeomAbs_G2 :{ if (surfconti.IsG2()) 
			 ...
			 o<<" G0Value = "<<surfconti.C0Value().getValue()<<endl;
			 o<<" G1Value = "<<surfconti.G1Angle().getValue()<<endl;
			 o<<" G2CurvatureGap = "<<surfconti.G2CurvatureGap().getValue()<<endl;
		   	} break;  
...
{ if (!curvconti.IsDone()) 
  ...
  switch(curvconti.ContinuityStatus())
    { case GeomAbs_C0 :{  if (curvconti.IsC0() )
                          ...
                          o<<" C0Value = "<<curvconti.C0Value().getValue() <<endl;
		       } break; 
      case GeomAbs_C1 :{ if (curvconti.IsC1()) 
			 ...
			 o<<" C0Value = "<<curvconti.C0Value().getValue()<<endl;
			 o<<" C1Angle = "<<curvconti.C1Angle().getValue()<<endl;
                         o<<" C1Ratio = "<<curvconti.C1Ratio().getValue()<<endl;
      ...
      case GeomAbs_C2 :{ if (curvconti.IsC2()) 
			 ...
			 o<<" C0Value = "<<curvconti.C0Value().getValue()<<endl;
			 o<<" C1Angle = "<<curvconti.C1Angle().getValue()<<endl;
			 o<<" C2Angle = "<<curvconti.C2Angle().getValue()<<endl;
			 o<<" C1Ratio = "<<curvconti.C1Ratio().getValue()<<endl;
			 o<<" C2Ratio = "<<curvconti.C2Ratio().getValue()<<endl;
		       }break; 
      ...
      case GeomAbs_G1 :{  if (curvconti.IsG1()) 
			 ...
			 o<<" G0Value = "<<curvconti.C0Value().getValue()<<endl;
			 o<<" G1Angle = "<<curvconti.G1Angle().getValue()<<endl;
		       } break;
      case GeomAbs_G2 :{ if (curvconti.IsG2()) 
			 ...
			 o<<" G0Value = "<<curvconti.C0Value().getValue()<<endl;
			 o<<" G1Angle = "<<curvconti.G1Angle().getValue()<<endl;
			 o<<" G2Angle = "<<curvconti.G2Angle().getValue()<<endl;
			 o<<" Relative curvature variation = "<<curvconti.G2CurvatureVariation().getValue()<<endl;
