                                         ...
                                         Quantity_Parameter&    theAlpha) const
{
  ...
  switch (myImgFormat)
  {
    case ImgGrayF:
    {
      ...
      theAlpha = 1.0; // opaque
      return Quantity_Color (Quantity_Parameter (double (aPixel)),
                             Quantity_Parameter (double (aPixel)),
                             Quantity_Parameter (double (aPixel)),
                             Quantity_TOC_RGB);
    }
    case ImgAlphaF:
    ...
    case ImgRGBA:
    {
      ...
      theAlpha = double (aPixel.a()) / 255.0;
      return Quantity_Color (Quantity_Parameter (double (aPixel.r()) / 255.0),
                             Quantity_Parameter (double (aPixel.g()) / 255.0),
                             Quantity_Parameter (double (aPixel.b()) / 255.0),
                             Quantity_TOC_RGB);
    }
    case ImgBGRA:
    {
    ...
    case ImgGray:
    {
      ...
      theAlpha = 1.0; // opaque
      return Quantity_Color (Quantity_Parameter (double (aPixel) / 255.0),
                             Quantity_Parameter (double (aPixel) / 255.0),
                             Quantity_Parameter (double (aPixel) / 255.0),
                             Quantity_TOC_RGB);
    }
    case ImgAlpha:
