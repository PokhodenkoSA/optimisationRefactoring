...
static Handle(Draw_Drawable3D) pntrestore (istream& is)
{
  ...
  if (is3d)
    N = new DrawTrSurf_Point(gp_Pnt((Standard_Real)x,(Standard_Real)y,(Standard_Real)z),PntShape,PntColor);
  else
    N = new DrawTrSurf_Point(gp_Pnt2d((Standard_Real)x,(Standard_Real)y),PntShape,PntColor);
