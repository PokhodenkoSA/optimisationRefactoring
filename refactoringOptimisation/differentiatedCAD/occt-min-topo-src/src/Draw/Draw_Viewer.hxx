...
class Draw_Viewer {
  ...
  __Draw_API double   Zoom        (const Standard_Integer id) const;
  __Draw_API double   Focal       (const Standard_Integer id) const;
  ...
  __Draw_API void LastPick(gp_Pnt& P1, gp_Pnt& P2, double& Param);
