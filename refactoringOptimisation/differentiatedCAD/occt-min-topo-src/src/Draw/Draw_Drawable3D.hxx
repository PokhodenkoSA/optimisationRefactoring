...
public:
  ...
  Standard_EXPORT void SetBounds (const double xmin, const double xmax, const double ymin, const double ymax);
  
  Standard_EXPORT void Bounds (double& xmin, double& xmax, double& ymin, double& ymax) const;
