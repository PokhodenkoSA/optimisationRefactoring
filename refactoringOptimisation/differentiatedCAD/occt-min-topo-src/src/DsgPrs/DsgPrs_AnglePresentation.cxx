                                    ...
                                    const Standard_Real aArrowSize) 
{
  ...
  Standard_Real tmp;
  const Standard_Real myArrowSize = ( aArrowSize == 0.0 )? (tmp = (0.1 * aCircle.Radius())) : aArrowSize;
                                    ...
                                    const gp_Pnt& OffsetPoint)
{
  ...
  const Standard_Integer nbp = Max (4 , Standard_Integer (50. * alpha.getValue() / M_PI));
                                    ...
                                    const DsgPrs_ArrowSide ArrowPrs )
{
  ...
  if (theval > Precision::Angular() && Abs( M_PI-theval ) > Precision::Angular())
  {
    ...
    const Standard_Integer NodeNumber = Max (4 , Standard_Integer (50. * Alpha.getValue() / M_PI));
                                    ...
                                    const DsgPrs_ArrowSide ArrowSide)
{
  ...
  const Standard_Integer nbp = Max (4 , Standard_Integer (50. * theval.getValue() / M_PI));
