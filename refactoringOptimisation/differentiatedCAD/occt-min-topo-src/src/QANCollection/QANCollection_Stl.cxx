...
void TestPerformanceRandomIterator(Draw_Interpretor& di)
{
  ...
  for (Standard_Integer aSize = 10000; aSize <= 1280000; aSize *= 2)
  {
    ...
    double aStlTime = aTimer.ElapsedTime();
    ...
    double aOccTime = aTimer.ElapsedTime();
...
static Standard_Integer QANTestNCollectionIndexedMap (Draw_Interpretor& di, Standard_Integer, const char**)
{
  ...
  const double aTime1 = aTimer.ElapsedTime();
  ...
  const double aTime2 = aTimer.ElapsedTime();
  ...
  const double aTime3 = aTimer.ElapsedTime();
  ...
  const double aTime4 = aTimer.ElapsedTime();
