   ...
   const Handle(Message_Messenger)& S, const Standard_Integer level)  const
{
  ...
  S << "Scale Factor : " << ent->ScaleFactor().getValue() << endl;
  ...
  S << endl << "View Plane Distance      : " << ent->ViewPlaneDistance().getValue()<<endl;
  S << "Left   Side Of Clipping Window : " << ent->TopLeft().X().getValue()     << endl;
  S << "Right  Side Of Clipping Window : " << ent->BottomRight().X().getValue() << endl;
  S << "Bottom Side Of Clipping Window : " << ent->BottomRight().Y().getValue() << endl;
  S << "Top    Side Of Clipping Window : " << ent->TopLeft().Y().getValue()     << endl;
  ...
  S << "Back Plane Distance  : " << ent->BackPlaneDistance().getValue()  << "  ";
  S << "Front Plane Distance : " << ent->FrontPlaneDistance().getValue() << endl;
  S << endl;
}
