...
public:
  ...
  Standard_EXPORT void Place (const Standard_Real X, const Standard_Real Y, const Standard_Real Z);
  
  Standard_EXPORT void Multiply (const Handle(Geom_Transformation)& aTransformation);
  
  Standard_EXPORT void Move (const Standard_Real X, const Standard_Real Y, const Standard_Real Z);
