...
Prs3d_ArrowAspect::Prs3d_ArrowAspect (const Standard_Real anAngle,
...
void Prs3d_ArrowAspect::SetAngle ( const Standard_Real anAngle) {
  Prs3d_InvalidAngle_Raise_if ( anAngle <= 0.  ||
                              anAngle >= M_PI /2. , "");
  myAngle = anAngle;
}
Standard_Real Prs3d_ArrowAspect::Angle () const
{
return myAngle;
}

void Prs3d_ArrowAspect::SetLength ( const Standard_Real aLength)
{
  myLength = aLength;
}
Standard_Real Prs3d_ArrowAspect::Length () const
{
return myLength;
}
