...
public:
  ...
  Standard_EXPORT Standard_Real FirstAxisLength() const;
  
  //! Returns the length of the displayed second axis.
  Standard_EXPORT Standard_Real SecondAxisLength() const;
  
  //! Returns the length of the displayed third axis.
  Standard_EXPORT Standard_Real ThirdAxisLength() const;
...
private:
  ...
  Standard_Real myFirstAxisLength;
  Standard_Real mySecondAxisLength;
  Standard_Real myThirdAxisLength;
