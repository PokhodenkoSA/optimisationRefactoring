...
void Prs3d_TextAspect::SetSpace(const Standard_Real aSpace) {
...
void Prs3d_TextAspect::SetAngle(const Standard_Real anAngle) {
  myAngle = anAngle;
}
...
Standard_Real Prs3d_TextAspect::Angle () const {return myAngle;}
