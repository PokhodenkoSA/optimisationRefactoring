...
void Prs3d_PlaneSet::SetOffset(const Standard_Real anOffset) {
...
Standard_Real Prs3d_PlaneSet::Offset () const {

  return myOffset;

}

void Prs3d_PlaneSet::Location(Standard_Real& X,Standard_Real& Y,Standard_Real& Z) const {

  myPlane.Location().Coord(X,Y,Z);
}

void Prs3d_PlaneSet::Direction(Standard_Real& X,Standard_Real& Y,Standard_Real& Z) const {
