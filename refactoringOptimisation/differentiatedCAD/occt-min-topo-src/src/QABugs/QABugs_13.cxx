...
//////////  }
  ...
  Standard_Real tmp;
  Standard_Integer NumXsubvolumes = (Standard_Integer)(tmp = (Xmax - Xmin) / mesh_delt); if (NumXsubvolumes <= 0) NumXsubvolumes = 1;
  Standard_Integer NumYsubvolumes = (Standard_Integer)(tmp = (Ymax - Ymin) / mesh_delt); if (NumYsubvolumes <= 0) NumYsubvolumes = 1;
  Standard_Integer NumZsubvolumes = (Standard_Integer)(tmp = (Zmax - Zmin) / mesh_delt); if (NumZsubvolumes <= 0) NumZsubvolumes = 1;
