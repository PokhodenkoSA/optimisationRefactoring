...
Storage_BaseDriver& FSD_CmpFile::PutReal(const double aValue)
{
...
Storage_BaseDriver& FSD_CmpFile::PutShortReal(const float aValue)
{
  myStream << aValue << " ";
  if (myStream.bad()) Storage_StreamWriteError::Raise();
  return *this;
...
Storage_BaseDriver& FSD_CmpFile::GetReal(double& aValue)
{
  char realbuffer[100];
...
Storage_BaseDriver& FSD_CmpFile::GetShortReal(float& aValue)
{
  char realbuffer[100];
  double r = 0.0;
