...
//  char sdi[1000];
  ...
  cout<<endl;
  Sprintf(stol,"%g",tole.getValue());
  cout<<"# "<<ste<<" : tole "<<stol<<" : uv "<<pe1.X().getValue()<<" "<<pe1.Y().getValue()<<" UV "<<pe2.X().getValue()<<" "<<pe2.Y().getValue();
  cout<<endl;
  Sprintf(stol,"%g",tol1.getValue());
  cout<<"# "<<sv1<<" : tol1 "<<stol<<" : uv "<<p1.X().getValue()<<" "<<p1.Y().getValue()<<" : edges "<<ste1;
  cout<<endl;
  Sprintf(stol,"%g",tol2.getValue());
  cout<<"# "<<sv2<<" : tol2 "<<stol<<" : uv "<<p2.X().getValue()<<" "<<p2.Y().getValue()<<" : edges "<<ste2;
  cout<<endl;
  Sprintf(stol,"%g",v1v2.getValue()); cout<<"# v1v2 = "<<stol;
  cout<<endl;
  cout.flush();
