...
public:
  ...
  Standard_EXPORT void SetNormals (const Handle(TColStd_HArray1OfReal)& theNormals);
  
  Standard_EXPORT const TColStd_Array1OfReal& Normals() const;
  
  Standard_EXPORT TColStd_Array1OfReal& ChangeNormals();
...
private:
  ...
  Handle(TColStd_HArray1OfReal) myNormals;
