...
Handle(Poly_Triangulation) Poly_Triangulation::Copy()
{
  ...
  if (HasNormals())
    aCopy->myNormals = new TColStd_HArray1OfReal(myNormals->Array1());
...
void Poly_Triangulation::SetNormals
                        (const Handle(TColStd_HArray1OfReal)& theNormals)
{
...
const TColStd_Array1OfReal& Poly_Triangulation::Normals() const
{
...
TColStd_Array1OfReal& Poly_Triangulation::ChangeNormals() 
{
