...
//purpose  :
//=======================================================================
void OSD_Chronometer::GetProcessCPU (double& UserSeconds, double& SystemSeconds)
{
  ...
  UserSeconds   = (double)CurrentTMS.tms_utime / aCLK_TCK;
  SystemSeconds = (double)CurrentTMS.tms_stime / aCLK_TCK;
}
...
//purpose  :
//=======================================================================
void OSD_Chronometer::GetThreadCPU (double& UserSeconds, double& SystemSeconds)
{
  FILETIME ftStart, ftExit, ftKernel, ftUser;
...
{
  double aCumulUserSec = Cumul_user;
  double aCumulSysSec  = Cumul_sys;
  if (!Stopped)
  {
...
//=======================================================================
void OSD_Chronometer::Show (double& theUserSec) const
{
...
//=======================================================================
void OSD_Chronometer::Show (double& theUserSec,
                            double& theSystemSec) const
{
  theUserSec   = Cumul_user;
