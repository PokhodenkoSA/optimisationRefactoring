...
Standard_Boolean OSD::IsDivisible(const double theDividend,const double theDivisor)
{
...
//   double aMant1 = frexp(theDividend, &aExp1);
//   double aMant2 = frexp(theDivisor, &aExp2);
#endif
// Code de :KL:dev:ref :
...
//Standard_Integer OSD::GetExponent(const double aReal)
Standard_Integer OSD::GetExponent(const double )
{
// Code de :KAS:C30 :
...
//double OSD::GetMantissa(const double aReal)
double OSD::GetMantissa(const double )
{
// Code de :KAS:C30 :
