        ...
        for (Standard_Integer aNodeIdx = 0; aNodeIdx < NbNodes - 2; ++aNodeIdx) // triangulate polygon
        {
          for (Standard_Integer aSubIdx = 0; aSubIdx < 3; ++aSubIdx) // generate sub-triangle
          {
            ...
            else
            {
              ...
              if (IsReflect)
              {
                aNColor.SetValues ((anColorRatio * aNColor.Red()).getValue(),
                                   (anColorRatio * aNColor.Green()).getValue(),
                                   (anColorRatio * aNColor.Blue()).getValue(),
                                   Quantity_TOC_RGB);
      ...
      for (Standard_Integer aNodeIdx = 0; aNodeIdx < aFaceNodes.Length() - 2; ++aNodeIdx) // triangulate polygon
      {
        for (Standard_Integer aSubIdx = 0; aSubIdx < 3; ++aSubIdx) // generate sub-triangle
        {
          ...
          else
          {
            ...
            if (theIsShaded)
            {
              aNColor.SetValues ((theColorRatio * aNColor.Red()).getValue(),
                                 (theColorRatio * aNColor.Green()).getValue(),
                                 (theColorRatio * aNColor.Blue()).getValue(),
                                 Quantity_TOC_RGB);
