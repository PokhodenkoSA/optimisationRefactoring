...
public:
  ...
  Standard_EXPORT void Values (Quantity_Color& AColor, Aspect_TypeOfMarker& AType, double& AScale) const;
...
protected:
  ...
  //! Warning: Raises AspectMarkerDefinitionError if the
  //! scale is a negative value.
  Standard_EXPORT Aspect_AspectMarker(const Quantity_Color& AColor, const Aspect_TypeOfMarker AType, const double AScale);
