...
public:
  ...
  Standard_EXPORT void Values (Quantity_Color& AColor, Aspect_TypeOfLine& AType, double& AWidth) const;
...
protected:
  ...
  Standard_EXPORT Aspect_AspectLine(const Quantity_Color& AColor, const Aspect_TypeOfLine AType, const double AWidth);
