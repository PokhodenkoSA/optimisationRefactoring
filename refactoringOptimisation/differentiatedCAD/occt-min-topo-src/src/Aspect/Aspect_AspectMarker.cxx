...
Aspect_AspectMarker::Aspect_AspectMarker (const Quantity_Color& AColor, const Aspect_TypeOfMarker AType, const double AScale) {
...
void Aspect_AspectMarker::SetScale (const double AScale) {
...
void Aspect_AspectMarker::Values (Quantity_Color& AColor, Aspect_TypeOfMarker& AType, double& AScale) const {
