...
static Standard_Integer anacurve (Draw_Interpretor& , Standard_Integer n, const char** a)
{
  ...
  if (!strcmp(a[0],"line")) {
    if (n == 6)
      result2d = new Geom2d_Line(gp_Pnt2d((Standard_Real)Draw::Atof(a[2]),(Standard_Real)Draw::Atof(a[3])),
				 gp_Dir2d((Standard_Real)Draw::Atof(a[4]),(Standard_Real)Draw::Atof(a[5])));
    else if (n == 8)
      result = new Geom_Line(gp_Pnt((Standard_Real)Draw::Atof(a[2]),(Standard_Real)Draw::Atof(a[3]),(Standard_Real)Draw::Atof(a[4])),
			     gp_Dir((Standard_Real)Draw::Atof(a[5]),(Standard_Real)Draw::Atof(a[6]),(Standard_Real)Draw::Atof(a[7])));
    else
      return 1;
  }
    ...
    if (n == 5)
      result2d = 
	new Geom2d_Circle(gp_Ax22d(gp_Pnt2d((Standard_Real)Draw::Atof(a[2]),(Standard_Real)Draw::Atof(a[3])),
				   gp_Dir2d(1,0)),
	    (Standard_Real)Draw::Atof(a[4]));
    else if (n == 6)
      result = 
	new Geom_Circle(gp_Ax2(gp_Pnt((Standard_Real)Draw::Atof(a[2]),(Standard_Real)Draw::Atof(a[3]),(Standard_Real)Draw::Atof(a[4])),
			       gp_Dir(0,0,1)),
	    (Standard_Real)Draw::Atof(a[5]));
    else if (n == 7)
      result2d =
	new Geom2d_Circle(gp_Ax22d(gp_Pnt2d((Standard_Real)Draw::Atof(a[2]),(Standard_Real)Draw::Atof(a[3])),
				   gp_Dir2d((Standard_Real)Draw::Atof(a[4]),(Standard_Real)Draw::Atof(a[5]))),
	    (Standard_Real)Draw::Atof(a[6]));
    else if (n == 9)
      result = 
	new Geom_Circle(gp_Ax2(gp_Pnt((Standard_Real)Draw::Atof(a[2]),(Standard_Real)Draw::Atof(a[3]),(Standard_Real)Draw::Atof(a[4])),
			       gp_Dir((Standard_Real)Draw::Atof(a[5]),(Standard_Real)Draw::Atof(a[6]),(Standard_Real)Draw::Atof(a[7]))),
	    (Standard_Real)Draw::Atof(a[8]));
    else if (n == 12)
      result = 
	new Geom_Circle(gp_Ax2(gp_Pnt((Standard_Real)Draw::Atof(a[2]),(Standard_Real)Draw::Atof(a[3]),(Standard_Real)Draw::Atof(a[4])),
			       gp_Dir((Standard_Real)Draw::Atof(a[5]),(Standard_Real)Draw::Atof(a[6]),(Standard_Real)Draw::Atof(a[7])),
			       gp_Dir((Standard_Real)Draw::Atof(a[8]),(Standard_Real)Draw::Atof(a[9]),(Standard_Real)Draw::Atof(a[10]))),
	    (Standard_Real)Draw::Atof(a[11]));
    else
      return 1;
  }
    ...
    if (n == 5)
      result2d = 
	new Geom2d_Parabola(gp_Ax22d(gp_Pnt2d((Standard_Real)Draw::Atof(a[2]),(Standard_Real)Draw::Atof(a[3])),
				     gp_Dir2d(1,0)),
	    (Standard_Real)Draw::Atof(a[4]));
    else if (n == 6)
      result = 
	new Geom_Parabola(gp_Ax2(gp_Pnt((Standard_Real)Draw::Atof(a[2]),(Standard_Real)Draw::Atof(a[3]),(Standard_Real)Draw::Atof(a[4])),
				 gp_Dir(0,0,1)),
	    (Standard_Real)Draw::Atof(a[5]));
    else if (n == 7)
      result2d = 
    ...
    if (n == 6)
      result2d = 
	new Geom2d_Ellipse(gp_Ax22d(gp_Pnt2d((Standard_Real)Draw::Atof(a[2]),(Standard_Real)Draw::Atof(a[3])),
				    gp_Dir2d(1,0)),
			   (Standard_Real)Draw::Atof(a[4]),(Standard_Real)Draw::Atof(a[5]));
    else if (n == 7)
      result = 
	new Geom_Ellipse(gp_Ax2(gp_Pnt((Standard_Real)Draw::Atof(a[2]),(Standard_Real)Draw::Atof(a[3]),(Standard_Real)Draw::Atof(a[4])),
				gp_Dir(0,0,1)),
			 (Standard_Real)Draw::Atof(a[5]),(Standard_Real)Draw::Atof(a[6]));
    else if (n == 8)
      result2d = 
	new Geom2d_Ellipse(gp_Ax22d(gp_Pnt2d((Standard_Real)Draw::Atof(a[2]),(Standard_Real)Draw::Atof(a[3])),
				    gp_Dir2d((Standard_Real)Draw::Atof(a[4]),(Standard_Real)Draw::Atof(a[5]))),
			   (Standard_Real)Draw::Atof(a[6]), (Standard_Real)Draw::Atof(a[7]));
    else if (n == 10)
      result = 
	new Geom_Ellipse(gp_Ax2(gp_Pnt((Standard_Real)Draw::Atof(a[2]),(Standard_Real)Draw::Atof(a[3]),(Standard_Real)Draw::Atof(a[4])),
				gp_Dir((Standard_Real)Draw::Atof(a[5]),(Standard_Real)Draw::Atof(a[6]),(Standard_Real)Draw::Atof(a[7]))),
			 (Standard_Real)Draw::Atof(a[8]), (Standard_Real)Draw::Atof(a[9]));
    else if (n == 13)
      result = 
	new Geom_Ellipse(gp_Ax2(gp_Pnt((Standard_Real)Draw::Atof(a[2]),(Standard_Real)Draw::Atof(a[3]),(Standard_Real)Draw::Atof(a[4])),
				gp_Dir((Standard_Real)Draw::Atof(a[5]),(Standard_Real)Draw::Atof(a[6]),(Standard_Real)Draw::Atof(a[7])),
				gp_Dir((Standard_Real)Draw::Atof(a[8]),(Standard_Real)Draw::Atof(a[9]),(Standard_Real)Draw::Atof(a[10]))),
			 (Standard_Real)Draw::Atof(a[11]), (Standard_Real)Draw::Atof(a[12]));
    else
      return 1;
  }
    ...
    if (n == 6)
      result2d = 
	new Geom2d_Hyperbola(gp_Ax22d(gp_Pnt2d((Standard_Real)Draw::Atof(a[2]),(Standard_Real)Draw::Atof(a[3])),
				      gp_Dir2d(1,0)),
			     (Standard_Real)Draw::Atof(a[4]),(Standard_Real)Draw::Atof(a[5]));
    else if (n == 7)
      result = 
	new Geom_Hyperbola(gp_Ax2(gp_Pnt((Standard_Real)Draw::Atof(a[2]),(Standard_Real)Draw::Atof(a[3]),(Standard_Real)Draw::Atof(a[4])),
				  gp_Dir(0,0,1)),
			   (Standard_Real)Draw::Atof(a[5]),(Standard_Real)Draw::Atof(a[6]));
    else if (n == 8)
      result2d = 
...
static Standard_Integer polecurve (Draw_Interpretor& , Standard_Integer n, const char** a)
{
  ...
  if (!strcmp(a[0],"beziercurve")) {
    ...
    k = 3;
    for (i = 1; i <= np; i++) {
      poles(i).SetCoord((Standard_Real)Draw::Atof(a[k]),(Standard_Real)Draw::Atof(a[k+1]),(Standard_Real)Draw::Atof(a[k+2]));
      k += 3;
      if (hasw) {
...
static Standard_Integer insertpole (Draw_Interpretor& di, Standard_Integer n, const char** a)
{
  ...
  Handle(Geom2d_BezierCurve) GBZ2d = DrawTrSurf::GetBezierCurve2d(a[1]);
  if (!GBZ.IsNull()) {
    gp_Pnt P ((Standard_Real)Draw::Atof(a[3]),(Standard_Real)Draw::Atof(a[4]),(Standard_Real)Draw::Atof(a[5]));
    if ( n == 7)
      GBZ->InsertPoleAfter(Index,P,(Standard_Real)Draw::Atof(a[6]));
    else
      GBZ->InsertPoleAfter(Index,P);
  }
  else if (!GBZ2d.IsNull()) {
    gp_Pnt2d P ((Standard_Real)Draw::Atof(a[3]),(Standard_Real)Draw::Atof(a[4]));
    if ( n == 6)
      GBZ2d->InsertPoleAfter(Index,P,(Standard_Real)Draw::Atof(a[5]));
    else
...
static Standard_Integer point(Draw_Interpretor& , Standard_Integer n, const char** a)
{
  if (n < 4) return 1;
  if (n >= 5) {
    gp_Pnt P((Standard_Real)Draw::Atof(a[2]),(Standard_Real)Draw::Atof(a[3]),(Standard_Real)Draw::Atof(a[4]));
    DrawTrSurf::Set(a[1],P);
  }
  else {
    gp_Pnt2d P((Standard_Real)Draw::Atof(a[2]),(Standard_Real)Draw::Atof(a[3]));
    DrawTrSurf::Set(a[1],P);
  }
