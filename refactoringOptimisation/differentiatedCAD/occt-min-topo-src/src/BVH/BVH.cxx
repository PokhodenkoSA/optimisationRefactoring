...
template class NCollection_Vec2<Standard_ShortReal>;
template class NCollection_Vec3<Standard_ShortReal>;
template class NCollection_Vec4<Standard_ShortReal>;
