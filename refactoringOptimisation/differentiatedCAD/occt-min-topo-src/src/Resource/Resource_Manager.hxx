...
public:
  ...
  //! and its type.
  Standard_EXPORT virtual double Real (const Standard_CString aResourceName) const;
  ...
  //! If the resource does not exist, it is created.
  Standard_EXPORT virtual void SetResource (const Standard_CString aResourceName, const double aValue);
