...
static Standard_Boolean MergeSubSeq(const TopTools_SequenceOfShape& aChain, TopoDS_Edge& OutEdge, Standard_Real Tol, Standard_Boolean ConcatBSplines)
{
  ShapeAnalysis_Edge sae;
  BRep_Builder B;
...
static Standard_Boolean IsMergingPossible(const TopoDS_Edge& edge1, const TopoDS_Edge& edge2, 
                                          Standard_Real Tol, const TopTools_MapOfShape& DegEdgeVrt)
{
...
static void GenerateSubSeq (const TopTools_SequenceOfShape& anInpEdgeSeq,
                            ...
                            Standard_Boolean IsClosed, Standard_Real Tol, const TopTools_MapOfShape& DegEdgeVrt )
{
