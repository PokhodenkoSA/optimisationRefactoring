...
public:
  ...
  //! Set or drop infinite mode for the current scale
    ...
    void SetScale (const Standard_CString name, const double min, const double max, const double step, const Standard_Boolean isInf = Standard_False);
  
  //! Set all parameters for current scale
  Standard_EXPORT void SetScale (const double min, const double max, const double step, const Standard_Boolean isInf = Standard_False);
  
  //! Returns all parameters for current scale
  Standard_EXPORT void GetScale (double& min, double& max, double& step, Standard_Boolean& isInf) const;
  ...
  //! Increment the progress value by the default of specified step
    void Increment (const double step);
    ...
    Standard_Boolean NewScope (const double span, const Standard_CString name = 0);
  ...
  Standard_EXPORT Standard_Boolean NewScope (const double span, const Handle(TCollection_HAsciiString)& name);
  ...
  Standard_EXPORT Standard_Boolean NextScope (const double span, const Standard_CString name = 0);
