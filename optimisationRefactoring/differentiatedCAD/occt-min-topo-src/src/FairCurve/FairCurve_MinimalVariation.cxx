...
o << "  P1    X      |"; o.width(7); o<<  OldP1.X().getValue() << " | " << NewP1.X().getValue() << endl;
o << "        Y      |"; o.width(7); o<<  OldP1.Y().getValue() << " | " << NewP1.Y().getValue() << endl;
o << "  P2    X      |"; o.width(7); o<<  OldP2.X().getValue() << " | " << NewP2.X().getValue() << endl;
o << "        Y      |"; o.width(7); o<<  OldP2.Y().getValue() << " | " << NewP2.Y().getValue() << endl;
o << "      Angle1   |"; o.width(7); o<<  OldAngle1.getValue() << " | " << NewAngle1.getValue() << endl;
o << "      Angle2   |"; o.width(7); o<<  OldAngle2.getValue() << " | " << NewAngle2.getValue() << endl;
o << " Curvature1    |"; o.width(7); o<<  OldCurvature1.getValue() << " | " << NewCurvature1.getValue() << endl;
o << " Curvature2    |"; o.width(7); o<<  OldCurvature2.getValue() << " | " << NewCurvature2.getValue() << endl;
o << "      Height   |"; o.width(7); o<<  OldHeight.getValue() << " | " << NewHeight.getValue() << endl;
o << "      Slope    |"; o.width(7); o<<  OldSlope.getValue()  << " | " << NewSlope.getValue() << endl;
o << " PhysicalRatio |"; o.width(7); o<<  OldPhysicalRatio.getValue() << " | " << NewPhysicalRatio.getValue() << endl;
o << " SlidingFactor |"; o.width(7); o<<  OldSlidingFactor.getValue() << " | " << NewSlidingFactor.getValue() << endl;
