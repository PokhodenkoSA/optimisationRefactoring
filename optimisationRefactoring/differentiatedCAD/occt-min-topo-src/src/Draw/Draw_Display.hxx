...
public:
  ...
  Standard_EXPORT void Draw (const gp_Circ& C, Standard_Real A1, Standard_Real A2, const Standard_Boolean ModifyWithZoom = Standard_True);
  
  //! Draw  a 2D circle  <C>  from angle   <A1> to <A2>
  //! (Radians). if ModifyWithZoom  = 0,  then
  //! rayon of circle is convert to Integer.
  Standard_EXPORT void Draw (const gp_Circ2d& C, const Standard_Real A1, Standard_Real A2, const Standard_Boolean ModifyWithZoom = Standard_True);
  ...
  Standard_EXPORT void DrawMarker (const gp_Pnt2d& pt, const Draw_MarkerShape S, Standard_Real Size);
