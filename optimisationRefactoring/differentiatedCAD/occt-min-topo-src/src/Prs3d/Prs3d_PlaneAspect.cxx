...
void Prs3d_PlaneAspect::SetPlaneLength(const Standard_Real lX,
				       const Standard_Real lY)
{
  myPlaneXLength = lX;
  myPlaneYLength = lY;
}

Standard_Real Prs3d_PlaneAspect::PlaneXLength() const
{
  return myPlaneXLength;
}

Standard_Real Prs3d_PlaneAspect::PlaneYLength() const
{
  return myPlaneYLength;
}

void Prs3d_PlaneAspect::SetIsoDistance(const Standard_Real l) 
{
  myIsoDistance = l;
}

Standard_Real Prs3d_PlaneAspect::IsoDistance() const
{
  return myIsoDistance;
}

void Prs3d_PlaneAspect::SetArrowsLength(const Standard_Real L)
{
  myArrowsLength = L;
}

Standard_Real Prs3d_PlaneAspect::ArrowsLength() const
{
  return myArrowsLength;
}

void Prs3d_PlaneAspect::SetArrowsSize(const Standard_Real L)
{
  myArrowsSize = L;
}

Standard_Real Prs3d_PlaneAspect::ArrowsSize() const
{
  return myArrowsSize;
}

void Prs3d_PlaneAspect::SetArrowsAngle(const Standard_Real ang)
{
  myArrowsAngle = ang;
}

Standard_Real Prs3d_PlaneAspect::ArrowsAngle() const
{
