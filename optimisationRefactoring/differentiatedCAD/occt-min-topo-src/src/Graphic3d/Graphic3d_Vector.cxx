...
MyX (Standard_ShortReal (AX.getValue())),
MyY (Standard_ShortReal (AY.getValue())),
MyZ (Standard_ShortReal (AZ.getValue())),
MyNorme (Standard_ShortReal (Graphic3d_Vector::NormeOf (AX, AY, AZ).getValue())) {
}
...
Graphic3d_Vector::Graphic3d_Vector (const Graphic3d_Vertex& APoint1, const Graphic3d_Vertex& APoint2) {
	...
	MyNorme	= Standard_ShortReal (Graphic3d_Vector::NormeOf (MyX, MyY, MyZ).getValue());
...
void Graphic3d_Vector::SetCoord (const Standard_Real Xnew, const Standard_Real Ynew, const Standard_Real Znew) {
	...
	MyX	= Standard_ShortReal (Xnew.getValue());
	MyY	= Standard_ShortReal (Ynew.getValue());
	MyZ	= Standard_ShortReal (Znew.getValue());

	MyNorme	= Standard_ShortReal (Graphic3d_Vector::NormeOf (Standard_Real (MyX), Standard_Real (MyY), Standard_Real (MyZ)).getValue());
