  ...
  for (i = 1; i <= myNbrShell; i++) {
    ...
    for (mySegListIt.Initialize((*psd2)->Edges());
	 ...
	 mySegListIt.Next()) {      
      ...
      nxMin = (Standard_Integer)((DecaX + xSegmnMin) * SurDX).getValue();
      nyMin = (Standard_Integer)((DecaY + ySegmnMin) * SurDY).getValue();
      nzMin = (Standard_Integer)((DecaZ + zSegmnMin) * SurDZ).getValue();
      nxMax = (Standard_Integer)((DecaX + xSegmnMax) * SurDX).getValue();
      nyMax = (Standard_Integer)((DecaY + ySegmnMax) * SurDY).getValue();
      nzMax = (Standard_Integer)((DecaZ + zSegmnMax) * SurDZ).getValue();
	...
	for (otheri = 1; otheri <= nbT; otheri++) {
	  ...
	  if (TriFlags & FMskHiding) {
	    ...
	    nxMin = (Standard_Integer)((DecaX + xTrianMin) * SurDX).getValue();
	    nyMin = (Standard_Integer)((DecaY + yTrianMin) * SurDY).getValue();
	    nzMin = (Standard_Integer)((DecaZ + zTrianMin) * SurDZ).getValue();
	    nxMax = (Standard_Integer)((DecaX + xTrianMax) * SurDX).getValue();
	    nyMax = (Standard_Integer)((DecaY + yTrianMax) * SurDY).getValue();
	    nzMax = (Standard_Integer)((DecaZ + zTrianMax) * SurDZ).getValue();
	...
	nxMin = (Standard_Integer)((DecaX + xPolyTMin) * SurDX).getValue();
	nyMin = (Standard_Integer)((DecaY + yPolyTMin) * SurDY).getValue();
	nzMin = (Standard_Integer)((DecaZ + zPolyTMin) * SurDZ).getValue();
	nxMax = (Standard_Integer)((DecaX + xPolyTMax) * SurDX).getValue();
	nyMax = (Standard_Integer)((DecaY + yPolyTMax) * SurDY).getValue();
	nzMax = (Standard_Integer)((DecaZ + zPolyTMax) * SurDZ).getValue();
    ...
    if (nbFaHi > 0) {
      nxMin = (Standard_Integer)((DecaX + xShellMin) * SurDX).getValue();
      nyMin = (Standard_Integer)((DecaY + yShellMin) * SurDY).getValue();
      nzMin = (Standard_Integer)((DecaZ + zShellMin) * SurDZ).getValue();
      nxMax = (Standard_Integer)((DecaX + xShellMax) * SurDX).getValue();
      nyMax = (Standard_Integer)((DecaY + yShellMax) * SurDY).getValue();
      nzMax = (Standard_Integer)((DecaZ + zShellMax) * SurDZ).getValue();
			     ...
			     Standard_Boolean& intl)
{
  ...
  const Standard_Address IndexPtr = BP.Indices();
  status = HLRAlgo_EdgeStatus(0.,(Standard_ShortReal)myTolParam.getValue(),1.,(Standard_ShortReal)myTolParam.getValue());
  Index = ShapeIndex;
  reg1       = BP.Rg1Line();
  regn       = BP.RgNLine();
  outl       = BP.OutLine();
