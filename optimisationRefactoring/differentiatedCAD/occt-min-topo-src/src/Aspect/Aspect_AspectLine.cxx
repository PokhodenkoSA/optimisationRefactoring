...
Aspect_AspectLine::Aspect_AspectLine (const Quantity_Color& AColor, const Aspect_TypeOfLine AType, const double AWidth) {
...
void Aspect_AspectLine::SetWidth (const double AWidth) {
...
void Aspect_AspectLine::Values (Quantity_Color& AColor, Aspect_TypeOfLine& AType, double& AWidth) const {
