                                 ...
                                 const Standard_Integer level)  const
{
  ...
  S << "Plane Coefficient A : " << A.getValue() << endl;
  S << "Plane Coefficient B : " << B.getValue() << endl;
  S << "Plane Coefficient C : " << C.getValue() << endl;
  S << "Plane Coefficient D : " << D.getValue() << endl;
  ...
  S << "  Size  : " << ent->SymbolSize().getValue() << endl;
}
