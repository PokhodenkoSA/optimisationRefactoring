                            ...
                            const Handle(Adaptor3d_HSurface)& Surf) { 
                              ...
                              if(typl == Contap_Walking) { 
                                ...
                                for(Standard_Integer i=1;i<nbvtx;i++) { 
                                  Standard_Integer firstp = (Standard_Integer) L.Vertex(i).ParameterOnLine().getValue();
                                  Standard_Integer lastp =  (Standard_Integer) L.Vertex(i+1).ParameterOnLine().getValue();
                                  if(firstp!=lastp) {  
                ...
                if (projok) {
                  ...
                  if (dist <= Preci) {
                    ...
                    Standard_Integer Paraml =
                      (Standard_Integer) ptvt.ParameterOnLine().getValue();
