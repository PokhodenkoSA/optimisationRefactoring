...
static Standard_Integer OCC6143 (Draw_Interpretor& di, Standard_Integer argc, const char ** argv)
{
  ...
  {//==== Test Divide ByZero (Real) ===========================================
    try{
      ...
      res = a / b;
      di << " 4.0 / 0.0 = " << res.getValue() << "  Does not Caught... OK"<< "\n";
    }
  ...
  {//==== Test Overflow (Real) ================================================ 
    try{
      ...
      di << "-- "<<res.getValue()<<"="<<r.getValue()<<"*"<<r.getValue()<<"   Does not Caught... OK"<< "\n";
    }
  ...
  {//==== Test Underflow (Real) ===============================================
    try{
      ...
      //++++ Succes = Standard_False;
      di<<" -- "<<res.getValue()<<"="<<r.getValue()<<"*"<<r.getValue()<<"   Does not Caught... (But) Ok"<<"\n";
    }
  ...
  {//==== Test Invalid Operation (Real) ===============================================
    try{
      ...
      res = sqrt(r);
      di<<" "<<res.getValue()<<"=sqrt("<<r.getValue()<<")  Does not Caught... OK"<<"\n";
    }
    catch(Standard_NumericError) {
      di << " KO"<< "\n";
      Succes = Standard_False;
