...
public:
  ...
  //! does not overflow
  Standard_EXPORT static Standard_Boolean IsDivisible (const double aDividend, const double aDivisor);
  
  //! Returns the exponent in base 2 of a floating-point number.
  Standard_EXPORT static Standard_Integer GetExponent (const double aReal);
  
  //! Returns the mantissa of a floating-point number.
  Standard_EXPORT static double GetMantissa (const double aReal);
