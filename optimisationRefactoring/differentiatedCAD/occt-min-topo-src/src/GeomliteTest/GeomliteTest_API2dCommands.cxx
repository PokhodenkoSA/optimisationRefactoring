...
static Standard_Integer intersect(Draw_Interpretor& di, Standard_Integer n, const char** a)
{
  ...
  for ( i = 1; i <= Intersector.NbPoints(); i++) {
    ...
    di<<"parameter on the fist: "<<Intersector.Intersector().Point(i).ParamOnFirst().getValue();
    di<<" parameter on the second: "<<Intersector.Intersector().Point(i).ParamOnSecond().getValue()<<"\n";
