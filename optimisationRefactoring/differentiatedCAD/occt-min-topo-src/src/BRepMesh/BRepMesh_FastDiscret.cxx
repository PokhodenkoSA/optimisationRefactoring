  ...
  try
  {
    ...
    if (!myShapetrigu || aTriangulation.IsNull())
    {
      ...
      if (aSurfType == GeomAbs_Torus)
      {
        ...
        Standard_Integer nbV = Max((Standard_Integer)((myvmax-myvmin)/Dv).getValue(), 2);
        ...
        Standard_Integer nbU = Max((Standard_Integer)((myumax-myumin)/Du).getValue(), 2);
        nbU = Max(nbU, (Standard_Integer)(nbV*(myumax-myumin)*R/((myvmax-myvmin)*r)/5.).getValue());
