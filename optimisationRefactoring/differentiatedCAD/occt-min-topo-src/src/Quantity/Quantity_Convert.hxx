...
public:
  ...
  //! from the user system to the SI system.
    static double ConvertUserToSI (const Quantity_PhysicalQuantity aQuantity, const double aVal);
  
  //! Converts, from the conversion table, the value <aVal>
  //! from the SI system to the user system.
    static double ConvertSIToUser (const Quantity_PhysicalQuantity aQuantity, const double aVal);
