...
{ 
  ...
  S << "Text Area  : Width : " << ent->TextWidth().getValue() << "  ";
  S << "Height : " << ent->TextHeight().getValue() << "  ";
  ...
  S << "Rotation Angle of Text : " << ent->AreaRotationAngle().getValue() << endl;
  S << "Base Line Position : ";
  IGESData_DumpXYZL(S,level, ent->BaseLinePosition(), ent->Location());
  S << "Normal Interline Spacing : " << ent->NormalInterlineSpace().getValue() << endl;
  ...
  if (level > 4)
      ...
      for ( Standard_Integer i = 1; i <= nbval; i++)
	{
          ...
          S << "Character Width   : " << ent->CharacterWidth(i).getValue()   << "  ";
          S << "Character Height  : " << ent->CharacterHeight(i).getValue()  << endl;
          S << "Inter Character Spacing : "<<ent->InterCharacterSpace(i).getValue()<<"  ";
          S << "Interline Spacing : " << ent->InterlineSpace(i).getValue() << endl;
          S << "Font Styles       : " << ent->FontStyle(i) << endl;
          S << "Character Angle   : " << ent->CharacterAngle(i).getValue() << endl;
          S << "Control Code String : " ;
          IGESData_DumpString(S,ent->ControlCodeString(i));
          S << endl;
          S << "Number of Characters : " << ent->NbCharacters(i) << "  ";
          S << "Box Width  : " << ent->BoxWidth(i).getValue()  << "  ";
          S << "Box Height : " << ent->BoxHeight(i).getValue() << endl;
          if (ent->IsCharSetEntity(i))
	    {
	    ...
	    S << "Character Set Code : " << ent->CharSetCode(i) << endl;
          ...
          S << "Slant Angle : "    << ent->SlantAngle(i).getValue() << "  ";
          S << "Rotation Angle : " << ent->RotationAngle(i).getValue() << "  ";
