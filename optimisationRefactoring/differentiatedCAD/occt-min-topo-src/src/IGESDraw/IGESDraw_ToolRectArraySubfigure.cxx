   ...
   const Handle(Message_Messenger)& S, const Standard_Integer level)  const
{
  ...
  S << endl;
  S << "Scale Factor : " << ent->ScaleFactor().getValue() << "  ";
  ...
  S << "Horizontal Distance Between Columns : " << ent->ColumnSeparation().getValue()<<endl;
  S << "Vertical Distance Between Rows      : " << ent->RowSeparation().getValue() <<endl;
  S << "Rotation Angle (in radians)         : " << ent->RotationAngle().getValue() <<endl;
  S << "Do-Dont Flag : ";
