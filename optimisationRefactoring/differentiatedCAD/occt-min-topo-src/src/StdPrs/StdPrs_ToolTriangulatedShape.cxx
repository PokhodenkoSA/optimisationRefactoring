                                           ...
                                           TColgp_Array1OfDir& theNormals)
{
  ...
  if (aPolyTri->HasNormals())
  {
    ...
    const TColStd_Array1OfReal& aNormals = aPolyTri->Normals();
    const Standard_Real*       aNormArr = &(aNormals.Value (aNormals.Lower()));
  ...
  Handle(TColStd_HArray1OfReal) aNormals = new TColStd_HArray1OfReal (1, aPolyTri->NbNodes() * 3);
  ...
  for (Standard_Integer aNodeIter = aNodes.Lower(); aNodeIter <= aNodes.Upper(); ++aNodeIter)
  {
    ...
    aNormals->SetValue (anId + 1, (Standard_ShortReal )theNormals (aNodeIter).X().getValue());
    aNormals->SetValue (anId + 2, (Standard_ShortReal )theNormals (aNodeIter).Y().getValue());
    aNormals->SetValue (anId + 3, (Standard_ShortReal )theNormals (aNodeIter).Z().getValue());
  }
