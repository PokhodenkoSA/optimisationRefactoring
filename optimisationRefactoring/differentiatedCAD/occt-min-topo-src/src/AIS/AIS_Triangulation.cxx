                                ...
                                const Standard_Integer aMode)
{
  switch (aMode) 
  {
    case 0:
      ...
      if (hasVNormals)
      {
        const TColStd_Array1OfReal& normals = myTriangulation->Normals();
        if (hasVColors)
        {
                                                    ...
                                                    const Standard_Real aComposition)
{
  ...
  red   = (Standard_Integer)(aComposition * red).getValue();
  green = (Standard_Integer)(aComposition * green).getValue();
  blue  = (Standard_Integer)(aComposition * blue).getValue();
