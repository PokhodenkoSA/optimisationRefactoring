...
void AppDef_Variational::Dump(Standard_OStream& o) const 
{
  ...
  o << " \nTolerance " << o.setf(ios::scientific) << setprecision(3) << setw(9) << myTolerance.getValue();
  if ( WithMinMax()) { o << "  as Max Error." << endl;}
  else { o << "  as size Error." << endl;}
  o << "CriteriumWeights : " << myPercent[0].getValue() << " , "
    << myPercent[1].getValue() << " , " << myPercent[2].getValue() << endl;

  if (myIsDone ) {
    o << " MaxError             " << setprecision(3) << setw(9) << myMaxError.getValue() << endl;
    o << " Index of  MaxError   " << myMaxErrorIndex << endl;
    o << " Average Error        " << setprecision(3) << setw(9) << myAverageError.getValue() << endl;
    o << " Quadratic Error      " << setprecision(3) << setw(9) << myCriterium[0].getValue() << endl;
    o << " Tension Criterium    " << setprecision(3) << setw(9) << myCriterium[1].getValue() << endl;
    o << " Flexion  Criterium   " << setprecision(3) << setw(9) << myCriterium[2].getValue() << endl;
    o << " Jerk  Criterium      " << setprecision(3) << setw(9) << myCriterium[3].getValue() << endl;
