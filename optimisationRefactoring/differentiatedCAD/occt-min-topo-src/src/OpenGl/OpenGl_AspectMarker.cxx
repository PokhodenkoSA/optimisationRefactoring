                           ...
                           Standard_Integer& theNumOfBytes)
{
  ...
  Standard_Integer anId = (Standard_Integer )(anIndex.getValue() + 0.5);
  if (anId < 0)
  {
    anId = 0;
  }
    ...
    else
    {
      ...
      switch (theType)
      {
        ...
        case Aspect_TOM_BALL:
        {
          ...
          NCollection_Vec4<double> aColor (double (theColor.rgb[0]),
                                                  double (theColor.rgb[1]),
                                                  double (theColor.rgb[2]),
                                                  double (theColor.rgb[3]));
