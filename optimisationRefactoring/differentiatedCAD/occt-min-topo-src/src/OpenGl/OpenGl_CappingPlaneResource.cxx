...
void OpenGl_CappingPlaneResource::UpdateTransform()
{
  ...
  Standard_ShortReal T[3] = 
    { (Standard_ShortReal)(tmp = (anEquation[0] * -anEquation[3])),
      (Standard_ShortReal)(tmp = (anEquation[1] * -anEquation[3])),
      (Standard_ShortReal)(tmp = (anEquation[2] * -anEquation[3])) };
  ...
  Standard_ShortReal aProjLen = 
    Sqrt (  (Standard_ShortReal)(tmp = (anEquation[0] * anEquation[0]))
          + (Standard_ShortReal)(tmp = (anEquation[2] * anEquation[2])));
