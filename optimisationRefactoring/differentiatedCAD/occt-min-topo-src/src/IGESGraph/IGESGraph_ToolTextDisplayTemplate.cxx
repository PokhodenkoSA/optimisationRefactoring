   ...
   const Handle(Message_Messenger)& S, const Standard_Integer level)  const
{
  ...
  S << "Character box width  : "  << ent->BoxWidth().getValue() << "  ";
  S << "Character box height : "  << ent->BoxHeight().getValue() << endl;
  if ( ent->IsFontEntity() )
    {
      S << "Font Entity : ";
  ...
  S << endl;
  S << "Slant angle    : "  << ent->SlantAngle().getValue() << "  ";
  S << "Rotation angle : "  << ent->RotationAngle().getValue() << endl;
