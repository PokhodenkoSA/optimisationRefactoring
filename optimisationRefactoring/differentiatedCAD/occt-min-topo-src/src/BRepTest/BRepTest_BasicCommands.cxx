...
static Standard_Integer maxtolerance(Draw_Interpretor& theCommands, 
  ...
  if(TmF<=TMF) sss << "\n    Face   : Min " << setw(8) << TmF.getValue() <<"    Max  " << setw(8) << TMF.getValue() << " \n ";
  if(TmE<=TME) sss << "\n    Edge   : Min " << setw(8) << TmE.getValue() <<"    Max  " << setw(8) << TME.getValue() << " \n ";
  if(TmV<=TMV) sss << "\n    Vertex : Min " << setw(8) << TmV.getValue() <<"    Max  " << setw(8) << TMV.getValue() << " \n ";
  theCommands << sss;
