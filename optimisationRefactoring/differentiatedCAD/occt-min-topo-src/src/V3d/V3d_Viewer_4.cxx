...
{
  myRGrid->SetGridValues (theXOrigin.getValue(), theYOrigin.getValue(), theXStep.getValue(), theYStep.getValue(), theRotationAngle.getValue());
  for (InitActiveViews(); MoreActiveViews(); NextActiveViews())
  {
...
void V3d_Viewer::SetCircularGridValues (const Standard_Real     theXOrigin,
                                        ...
                                        const Standard_Real theRotationAngle)
{
  myCGrid->SetGridValues (theXOrigin.getValue(), theYOrigin.getValue(), theRadiusStep.getValue(),
                          theDivisionNumber, theRotationAngle.getValue());
  for (InitActiveViews(); MoreActiveViews(); NextActiveViews())
  {
