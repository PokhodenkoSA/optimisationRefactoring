...
public:
  ...
  Standard_EXPORT void SetDefaultBackgroundColor (const Quantity_TypeOfColor Type, const Standard_Real V1, const Standard_Real V2, const Standard_Real V3);
  ...
  //! the viewer.
  Standard_EXPORT void SetDefaultViewSize (const Standard_Real Size);
  ...
  Standard_EXPORT void SetDefaultAngle (const Standard_Real Angle);
  ...
  Standard_EXPORT void DisplayPrivilegedPlane (const Standard_Boolean OnOff, const Standard_Real aSize = 1);
  ...
  Standard_EXPORT void DefaultBackgroundColor (const Quantity_TypeOfColor Type, Standard_Real& V1, Standard_Real& V2, Standard_Real& V3) const;
  ...
  Standard_EXPORT Standard_Real DefaultViewSize() const;
  ...
  Standard_EXPORT Standard_Real DefaultAngle() const;
