...
void V3d_Viewer::SetDefaultBackgroundColor(const Quantity_TypeOfColor Type, const Standard_Real v1, const Standard_Real v2, const Standard_Real v3) {
  ...
  Quantity_Color C(V1.getValue(),V2.getValue(),V3.getValue(),Type) ;
...
void V3d_Viewer::SetDefaultAngle(const Standard_Real Angle) {
...
Standard_Real V3d_Viewer::DefaultAngle() const {
