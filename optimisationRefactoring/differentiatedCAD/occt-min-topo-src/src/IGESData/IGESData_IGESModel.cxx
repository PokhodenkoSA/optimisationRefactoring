  ...
  (const Handle(Message_Messenger)& S, const Standard_Integer ) const
{
  ...
  S << "[13]  Scale                 : " << theheader.Scale().getValue()<<"\n";
