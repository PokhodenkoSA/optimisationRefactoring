...
{
  myTolStart = (Standard_ShortReal)Epsilon(myStart).getValue();
  myTolEnd   = (Standard_ShortReal)Epsilon(myEnd).getValue();
}
...
{
  Standard_ShortReal epsStart = (Standard_ShortReal)Epsilon(myStart).getValue();
  Standard_ShortReal epsEnd   = (Standard_ShortReal)Epsilon(myEnd).getValue();
