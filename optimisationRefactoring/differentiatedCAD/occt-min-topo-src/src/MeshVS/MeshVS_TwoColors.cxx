...
Quantity_Color ExtractColor ( MeshVS_TwoColors& theTwoColors, const Standard_Integer Index )
{
  ...
  if ( Index == 1 )
    aRes.SetValues ( (Standard_Real (theTwoColors.r1) / max).getValue(),
                     (Standard_Real (theTwoColors.g1) / max).getValue(),
                     (Standard_Real (theTwoColors.b1) / max).getValue(), Quantity_TOC_RGB );
  else if (Index == 2)
    aRes.SetValues ( (Standard_Real (theTwoColors.r2) / max).getValue(),
                     (Standard_Real (theTwoColors.g2) / max).getValue(),
                     (Standard_Real (theTwoColors.b2) / max).getValue(), Quantity_TOC_RGB );
...
{
  Standard_Real max = 255.0;
  theCol1.SetValues ( (Standard_Real (theTwoColors.r1) / max).getValue(),
                      (Standard_Real (theTwoColors.g1) / max).getValue(),
                      (Standard_Real (theTwoColors.b1) / max).getValue(), Quantity_TOC_RGB );
  theCol2.SetValues ( (Standard_Real (theTwoColors.r2) / max).getValue(),
                      (Standard_Real (theTwoColors.g2) / max).getValue(),
                      (Standard_Real (theTwoColors.b2) / max).getValue(), Quantity_TOC_RGB );
}
